...
export default function BookmarksPanel({ likes }: { likes: Like[] }) {
  ...
  const filtered = useMemo(() => {
    let result = likes.filter((l) => l.bookmarked)
    if (query.trim()) {
  ...
  const bookmarkCount = likes.filter((l) => l.bookmarked).length
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="mb-2">
        ...
        <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
          {bookmarkCount.toLocaleString()} bookmarked tweet{bookmarkCount !== 1 ? 's' : ''}
        </p>
      </div>
      ...
      {bookmarkCount === 0 ? (
        <div className="flex flex-col items-center gap-3 py-16">
          ...
          <p className="text-xs text-zinc-400 dark:text-zinc-500">
            Click the star icon on any tweet to bookmark it.
          </p>
        </div>
      ) : (
        <>
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="relative w-full sm:max-w-sm">
              ...
              <input
                ...
                placeholder="Search bookmarked tweets…"
          ...
          <div className="flex flex-col gap-3">
            ...
            {visible.length === 0 && (
              <div className="flex flex-col items-center gap-3 py-16">
                ...
                <p className="text-sm text-zinc-500 dark:text-zinc-400">
                  No bookmarked tweets match your search.
                </p>
                <p className="text-xs text-zinc-400 dark:text-zinc-500">
